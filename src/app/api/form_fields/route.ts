...
export const { GET, POST, PUT, DELETE } = createCrudRoutes({
  table: "form_fields",
  columns: ["form_key", "table_name", "field_name", "data_type", "max_length", "precision", "scale", "is_nullable", "default_value", "is_indexed", "is_unique", "is_copyable", "case_sensitive", "sort_order"],

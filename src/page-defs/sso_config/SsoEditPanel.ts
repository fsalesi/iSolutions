      ...
      new TabDef({
        ...
        children: [
          new SectionDef({
            ...
            columns:  2,
            children: [
              new FieldDef({ key: "provider_id", keyField: true }),
              new FieldDef({ key: "label", required: true }),
              new FieldDef({ key: "is_active", renderer: "checkbox" }),
              new FieldDef({ key: "show_on_login", renderer: "checkbox" }),
            ],
          }),
        ],
      }),
      ...
      new TabDef({
        ...
        children: [
          new SectionDef({
            ...
            columns:  1,
            children: [
              new FieldDef({ key: "client_id", required: true }),
          ...
          new SectionDef({
            ...
            columns:  1,
            children: [
              new FieldDef({ key: "authorization_url", required: true }),
              new FieldDef({ key: "token_url", required: true }),
              new FieldDef({ key: "logoff_url" }),
              new FieldDef({ key: "scope" }),
            ],
          }),
        ],
      }),
